...
export default async function WorkerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const whatsappMessage = [
    "Crown Accumulator - Salary Statement",
    `Worker: ${worker.name} (${worker.workerCode})`,
